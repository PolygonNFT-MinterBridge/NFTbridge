...
function loadBundle(data) {
    return databaseF55098ca.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return databaseF55098ca.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new databaseF55098ca.Query$1(_this, 
...
registerBundle(databaseF55098ca.Firestore);
