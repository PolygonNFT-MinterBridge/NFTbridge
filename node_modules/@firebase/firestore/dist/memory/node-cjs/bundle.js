...
function loadBundle(data) {
    return database04b190db.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database04b190db.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database04b190db.Query$1(this, 
...
registerBundle(database04b190db.Firestore);
